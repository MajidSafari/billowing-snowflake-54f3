...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/billowing-snowflake-54f3#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-snowflake-54f3
```

A live public deployment of this template is available at [https://billowing-snowflake-54f3.templates.workers.dev](https://billowing-snowflake-54f3.templates.workers.dev)
